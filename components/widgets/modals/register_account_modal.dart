...
///  Register account scrolleable window
///-----------------------------------------------------
///* - Made by: Neil Yesikov Cuadros miraval 👈(ﾟヮﾟ👈)
///  - email: 9780desarrollador09@gmail.com
///  - Date : 02/12/2021
Future<void> showRegisterAccountModal(BuildContext context) async => showModalBottomSheet(
      ...
      children: [
        ...
        Align(
          ...
          Padding(
            ...
            child: Text('Banco',
              style: Skin.dialogTextStyle(label: true),
            )
          )
        ),
        Padding(
        ...
        Padding(
          ...
          Row(
            children:[
              ...
              Text('(Opcional)',
                style: Skin.dialogTextStyle(helper: true),
              )
            ]
          )
        ),
        ...
        Align(
          ...
          Padding(
            padding: const EdgeInsets.only(left: 20, right: 20, bottom: 5),
            child: Text('N° de cuenta interbancaria',
              style: Skin.dialogTextStyle(label: true),
            )
          )
        ),
