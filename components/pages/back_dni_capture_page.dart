...
class BackDniCapturePage extends StatelessWidget {
  const BackDniCapturePage({ Key? key }) : super(key: key);
...
class BackCapture extends StatefulWidget {
  const BackCapture({ Key? key }) : super(key: key);

  @override
  _BackCaptureState createState() => _BackCaptureState();
}

class _BackCaptureState extends State<BackCapture> {
  File? backImage;
        ...
        Padding(padding: const EdgeInsets.all(60),
          child: Column(
            ...
            children: [
              ...
              const Text('Fotografie de manera horizontal la cara posterior de su DNI',
                style     : TextStyle(fontSize: 22, wordSpacing: 2),
                textAlign : TextAlign.center,
              ),
        ...
        Column(
          children: [
            ElevatedButton(
              ...
              onPressed : () {
                context.read<ClientProvider>().getDniBack(dniBack: backImage!);
