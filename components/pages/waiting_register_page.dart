...
class WaitingRegisterPage extends StatefulWidget {
  const WaitingRegisterPage({ Key? key }) : super(key: key);

  @override
  _WaitingRegisterPageState createState() => _WaitingRegisterPageState();
}

class _WaitingRegisterPageState extends State<WaitingRegisterPage> with SingleTickerProviderStateMixin{
